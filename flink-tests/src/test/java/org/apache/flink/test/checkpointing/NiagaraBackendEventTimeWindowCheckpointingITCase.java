...
/**
 * Integration tests for fully synchronous Niagara backend.
 */
public class NiagaraBackendEventTimeWindowCheckpointingITCase extends AbstractEventTimeWindowCheckpointingITCase {
	@BeforeClass
	...
	protected StateBackendEnum getStateBackend() {
		return StateBackendEnum.NIAGARA_FULLY_ASYNC;
	}
