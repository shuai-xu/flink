...
/**
 * Integration tests for incremental Niagara backend.
 */
public class IncrementalNiagaraBackendEventTimeWindowCheckpointingITCase extends AbstractEventTimeWindowCheckpointingITCase  {
	...
	protected StateBackendEnum getStateBackend() {
		return StateBackendEnum.NIAGARA_INCREMENTAL;
	}
