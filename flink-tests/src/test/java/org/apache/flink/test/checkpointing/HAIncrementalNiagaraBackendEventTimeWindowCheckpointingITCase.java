 ...
 */
public class HAIncrementalNiagaraBackendEventTimeWindowCheckpointingITCase extends AbstractEventTimeWindowCheckpointingITCase {
	...
	protected StateBackendEnum getStateBackend() {
		return StateBackendEnum.NIAGARA_INCREMENTAL_ZK;
	}
