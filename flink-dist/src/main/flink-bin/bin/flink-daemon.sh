...
code="${FLINK_LOG_PREFIX}.code"

log_setting=("-Dlog.file=${log}" "-Dcode.file=${code}" "-Dlog4j.configuration=file:${FLINK_CONF_DIR}/log4j.properties" "-Dlogback.configurationFile=file:${FLINK_CONF_DIR}/logback.xml")
