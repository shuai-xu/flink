...
import org.apache.flink.runtime.state3.keyed.KeyedValueStateTestBase;
...
/**
 * Test for KeyedValueState which use RocksDB as state backend.
 */
public class RocksDbKeyedValueStateTest extends KeyedValueStateTestBase {
	@ClassRule
