...
public class ClientCatalogFactory {
	private static final String PREFIXES_TO_CLEAN = CatalogConfigs.CATALOG_CONNECTOR_PREFIX + ".";

	public static ReadableCatalog createCatalog(Catalog catalog) {
		// TODO: convert to service discovery style

		CatalogType type = CatalogType.valueOf(catalog.getProperties().get(CatalogConfigs.CATALOG_TYPE));
		Map<String, String> cleaned = cleanProperties(catalog.getProperties());
