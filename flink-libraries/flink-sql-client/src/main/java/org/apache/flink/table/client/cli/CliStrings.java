...
public final class CliStrings {
	...
	public static final AttributedString MESSAGE_HELP = new AttributedStringBuilder()
		...
		.append(formatCommand(SqlCommand.DROP_TABLE, "Deletes a previously created table or virtual table. Syntax: 'DROP TABLE [IF EXISTS] <name>;'"))
		...
		.append(formatCommand(SqlCommand.DROP_VIEW, "Deletes a view. Syntax: 'DROP VIEW [IF EXISTS] <name>;'"))
		...
		.append(formatCommand(SqlCommand.DROP_FUNCTION, "Deletes a user defined function. Syntax: 'DROP FUNCTION [IF EXISTS] <name>;'"))
