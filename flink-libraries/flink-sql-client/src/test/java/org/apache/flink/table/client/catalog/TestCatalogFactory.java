...
public class TestCatalogFactory implements CatalogFactory {
	@Override
	public ReadableCatalog createCatalog(String catalogName, Map properties) {
		return new TestReadableCatalog(catalogName);
	}

	/**
	 * Catalog for test.
	 */
	public class TestReadableCatalog extends FlinkInMemoryCatalog {

		public TestReadableCatalog(String name) {
			super(name);
		}
	}
}
