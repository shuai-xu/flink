...
import java.lang.{Integer => JInt, Double => JDouble, Float => JFloat}
...
class AggregationITCase extends QueryTest {
  ...
  def testAggregationWithArithmetic(): Unit = {
    val t = tEnv.fromElements((1f, "Hello"), (2f, "Ciao"))
  ...
  def testStddevAndVariance(): Unit = {
    val t = tEnv.fromElements((1.0, 1), (1.0, 2), (2.0, 1), (2.0, 2), (3.0, 1), (3.0, 2))
  ...
  def testComplexAggregate(): Unit = {
    ...
    val t = CollectionBatchExecTable.get3TupleDataSet(tEnv, "a, b, c")
        .groupBy('b)
        .select('b, top10Fun('b.cast(DataTypes.INT), 'a.cast(DataTypes.FLOAT)))
