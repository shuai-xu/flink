...
class OuterJoinITCase(expectedJoinType: JoinType) extends QueryTest with JoinITCaseBase {
  ...
  def testLeftUpperAndLower(): Unit = {
    checkResult(
      "SELECT * FROM uppercasedata LEFT JOIN lowercasedata ON n = N",
      row(1, "A", 1, "a") ::
          row(2, "B", 2, "b") ::
          row(3, "C", 3, "c") ::
          row(4, "D", 4, "d") ::
    ...
    checkResult(
      "SELECT * FROM uppercasedata LEFT JOIN lowercasedata ON n = N AND n > 1",
      row(1, "A", null, null) ::
          row(2, "B", 2, "b") ::
          row(3, "C", 3, "c") ::
          row(4, "D", 4, "d") ::
    ...
    checkResult(
      "SELECT * FROM uppercasedata LEFT JOIN lowercasedata ON n = N AND l > L",
      row(1, "A", 1, "a") ::
          row(2, "B", 2, "b") ::
          row(3, "C", 3, "c") ::
          row(4, "D", 4, "d") ::
  ...
  def testRightUpperAndLower(): Unit = {
    checkResult(
      "SELECT * FROM lowercasedata RIGHT JOIN uppercasedata ON n = N",
      row(1, "a", 1, "A") ::
          row(2, "b", 2, "B") ::
          row(3, "c", 3, "C") ::
          row(4, "d", 4, "D") ::
    ...
    checkResult(
      "SELECT * FROM lowercasedata RIGHT JOIN uppercasedata ON n = N AND n > 1",
      row(null, null, 1, "A") ::
          row(2, "b", 2, "B") ::
          row(3, "c", 3, "C") ::
          row(4, "d", 4, "D") ::
    ...
    checkResult(
      ...
      row(null, null, 1, "A") ::
          ...
          row(null, null, 6, "F") :: Nil)
    checkResult(
      "SELECT * FROM lowercasedata RIGHT JOIN uppercasedata ON n = N AND l > L",
      row(1, "a", 1, "A") ::
          row(2, "b", 2, "B") ::
          row(3, "c", 3, "C") ::
          row(4, "d", 4, "D") ::
