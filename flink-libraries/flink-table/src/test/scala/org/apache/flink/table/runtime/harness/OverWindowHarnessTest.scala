...
class OverWindowHarnessTest(mode: StateBackendMode) extends HarnessTestBase(mode) {
  ...
  def testProcTimeBoundedRowsOver(): Unit = {
    ...
    val queryConfig: StreamQueryConfig =
    ...
    testHarness.processElement(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("aaa"), 1L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("bbb"), 10L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("aaa"), 2L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("aaa"), 3L: JLong)))

    // register cleanup timer with 4100
    testHarness.setProcessingTime(1100)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("bbb"), 20L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("aaa"), 4L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("aaa"), 5L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("aaa"), 6L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("bbb"), 30L: JLong)))

    // register cleanup timer with 6001
    testHarness.setProcessingTime(3001)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(2L: JLong, fromString("aaa"), 7L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(2L: JLong, fromString("aaa"), 8L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(2L: JLong, fromString("aaa"), 9L: JLong)))

    // trigger cleanup timer and register cleanup timer with 9002
    testHarness.setProcessingTime(6002)
    testHarness.processElement(new StreamRecord(
        GenericRow.of(2L: JLong, fromString("aaa"), 10L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(2L: JLong, fromString("bbb"), 40L: JLong)))
    ...
    expectedOutput.add(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("aaa"), 1L: JLong, 1L: JLong, 1L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("bbb"), 10L: JLong, 10L: JLong, 10L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("aaa"), 2L: JLong, 1L: JLong, 2L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("aaa"), 3L: JLong, 2L: JLong, 3L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("bbb"), 20L: JLong, 10L: JLong, 20L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("aaa"), 4L: JLong, 3L: JLong, 4L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("aaa"), 5L: JLong, 4L: JLong, 5L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("aaa"), 6L: JLong, 5L: JLong, 6L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(1L: JLong, fromString("bbb"), 30L: JLong, 20L: JLong, 30L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(2L: JLong, fromString("aaa"), 7L: JLong, 6L: JLong, 7L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(2L: JLong, fromString("aaa"), 8L: JLong, 7L: JLong, 8L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(2L: JLong, fromString("aaa"), 9L: JLong, 8L: JLong, 9L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(2L: JLong, fromString("aaa"), 10L: JLong, 10L: JLong, 10L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(2L: JLong, fromString("bbb"), 40L: JLong, 40L: JLong, 40L: JLong)))
  ...
  def testProcTimeBoundedRangeOver(): Unit = {
    ...
    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 1L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("bbb"), 10L: JLong)))

    testHarness.setProcessingTime(4)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 2L: JLong)))

    // trigger cleanup timer and register cleanup timer with 6003
    testHarness.setProcessingTime(3003)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 3L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("bbb"), 20L: JLong)))

    testHarness.setProcessingTime(5)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 4L: JLong)))
    ...
    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 5L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 6L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("bbb"), 30L: JLong)))

    // register cleanup timer with 14002
    testHarness.setProcessingTime(11002)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 7L: JLong)))

    testHarness.setProcessingTime(11004)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 8L: JLong)))

    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 9L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 10L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("bbb"), 40L: JLong)))
    ...
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 1L: JLong, 1L: JLong, 1L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("bbb"), 10L: JLong, 10L: JLong, 10L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 2L: JLong, 1L: JLong, 2L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 3L: JLong, 3L: JLong, 4L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("bbb"), 20L: JLong, 20L: JLong, 20L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 4L: JLong, 4L: JLong, 4L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 5L: JLong, 5L: JLong, 6L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 6L: JLong, 5L: JLong, 6L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("bbb"), 30L: JLong, 30L: JLong, 30L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 7L: JLong, 7L: JLong, 7L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 8L: JLong, 7L: JLong, 10L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 9L: JLong, 7L: JLong, 10L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 10L: JLong, 7L: JLong, 10L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("bbb"), 40L: JLong, 40L: JLong, 40L: JLong)))
    ...
    testHarness.processElement(new StreamRecord(GenericRow.of(0L: JLong, "ccc", 10L: JLong)))
  ...
  def testProcTimeUnboundedOver(): Unit = {
    ...
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 2L: JLong, 1L: JLong, 2L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 3L: JLong, 1L: JLong, 3L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("bbb"), 20L: JLong, 10L: JLong, 20L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 4L: JLong, 1L: JLong, 4L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 5L: JLong, 1L: JLong, 5L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 6L: JLong, 1L: JLong, 6L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("bbb"), 30L: JLong, 10L: JLong, 30L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 7L: JLong, 1L: JLong, 7L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 8L: JLong, 1L: JLong, 8L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 9L: JLong, 9L: JLong, 9L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("aaa"), 10L: JLong, 9L: JLong, 10L: JLong)))
    expectedOutput.add(new StreamRecord(
      GenericRow.of(0L: JLong, fromString("bbb"), 40L: JLong, 40L: JLong, 40L: JLong)))
  ...
  def testRowTimeBoundedRangeOver(): Unit = {
    ...
    val config = new StreamQueryConfig()
      .withIdleStateRetentionTime(Time.seconds(1), Time.seconds(2))
    val testHarness = createHarnessTester(t1.toAppendStream[Row](config), "over")
    val assertor = new BaseRowHarnessAssertor(
      Array(Types.LONG, Types.STRING, Types.LONG, Types.LONG, Types.LONG))
    ...
    testHarness.processElement(new StreamRecord(
      GenericRow.of(2L: JLong, fromString("aaa"), 1L: JLong)))

    testHarness.processWatermark(2)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(3L: JLong, fromString("bbb"), 10L: JLong)))

    testHarness.processWatermark(4000)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(4001L: JLong, fromString("aaa"), 2L: JLong)))

    testHarness.processWatermark(4001)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(4002L: JLong, fromString("aaa"), 3L: JLong)))

    testHarness.processWatermark(4002)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(4003L: JLong, fromString("aaa"), 4L: JLong)))

    testHarness.processWatermark(4800)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(4801L: JLong, fromString("bbb"), 25L: JLong)))

    testHarness.processWatermark(6500)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(6501L: JLong, fromString("aaa"), 5L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(6501L: JLong, fromString("aaa"), 6L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(6501L: JLong, fromString("bbb"), 30L: JLong)))

    testHarness.processWatermark(7000)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(7001L: JLong, fromString("aaa"), 7L: JLong)))

    testHarness.processWatermark(8000)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(8001L: JLong, fromString("aaa"), 8L: JLong)))

    testHarness.processWatermark(12000)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(12001L: JLong, fromString("aaa"), 9L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(12001L: JLong, fromString("aaa"), 10L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(12001L: JLong, fromString("bbb"), 40L: JLong)))
    ...
    testHarness.processElement(new StreamRecord(
      GenericRow.of(20001L: JLong, fromString("ccc"), 1L: JLong))) // clean-up 3000
    testHarness.setProcessingTime(2500)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(20002L: JLong, fromString("ccc"), 2L: JLong))) // clean-up 4500
    ...
    testHarness.processElement(new StreamRecord(
      GenericRow.of(20011L: JLong, fromString("ccc"), 3L: JLong))) // clean-up 6500
  ...
  def testRowTimeBoundedRowsOver(): Unit = {
    ...
    testHarness.processElement(new StreamRecord(
      GenericRow.of(801L: JLong, fromString("aaa"), 1L: JLong)))

    testHarness.processWatermark(2500)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(2501L: JLong, fromString("bbb"), 10L: JLong)))

    testHarness.processWatermark(4000)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(4001L: JLong, fromString("aaa"), 2L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(4001L: JLong, fromString("aaa"), 3L: JLong)))
    testHarness.processElement(new StreamRecord(
      GenericRow.of(4001L: JLong, fromString("bbb"), 20L: JLong)))

    testHarness.processWatermark(4800)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(4801L: JLong, fromString("aaa"), 4L: JLong)))
  ...
  def testRowTimeUnboundedRangeOver(): Unit = {
    ...
    testHarness.processWatermark(20000)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(20000L: JLong, "ccc", 1L: JLong))) // test for late data

    testHarness.processElement(new StreamRecord(
      GenericRow.of(20001L: JLong, fromString("ccc"), 1L: JLong))) // clean-up 5000
    testHarness.setProcessingTime(2500)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(20002L: JLong, fromString("ccc"), 2L: JLong))) // clean-up 5000
  ...
  def testRowTimeUnboundedRowsOver(): Unit = {
    ...
    testHarness.processWatermark(20000)
    testHarness.processElement(new StreamRecord(
      GenericRow.of(20000L: JLong, "ccc", 2L: JLong))) // test for late data
