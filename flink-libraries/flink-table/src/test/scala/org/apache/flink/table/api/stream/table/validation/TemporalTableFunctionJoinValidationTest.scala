...
class TemporalTableFunctionJoinValidationTest extends TableTestBase {
  ...
  def testInvalidFieldReference(): Unit = {
    ...
    expectedException.expectMessage("Cannot resolve [foobar]")
  ...
  def testNonTimeIndicatorOnRightSide(): Unit = {
    ...
    expectedException.expectMessage(
      "Invalid timeAttribute ['rowtime] in TemporalTableFunction")
