...
object TpcDsTableStatsProvider {
  ...
  val CALL_CENTER_1000 = TableStats(42L, Map[String, ColumnStats](
    ...
    "cc_rec_end_date" -> ColumnStats(3L, 21L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-12-30"),
      DateTimeTestUtil.UTCDate("1999-12-31")),
    ...
    "cc_rec_start_date" -> ColumnStats(4L, 1L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-12-31"),
      DateTimeTestUtil.UTCDate("1997-12-31")),
  ...
  val DATE_DIM_1000 = TableStats(73049L, Map[String, ColumnStats](
    ...
    "d_date" -> ColumnStats(72324L, 0L, 12.0D, 12, DateTimeTestUtil.UTCDate("2099-12-31"),
      DateTimeTestUtil.UTCDate("1900-01-02")),
  ...
  val ITEM_1000 = TableStats(300000L, Map[String, ColumnStats](
    ...
    "i_rec_start_date" -> ColumnStats(4L, 777L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-10-26"),
      DateTimeTestUtil.UTCDate("1997-10-26")),
    "i_rec_end_date" -> ColumnStats(3L, 150000L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-10-25"),
      DateTimeTestUtil.UTCDate("1999-10-26")),
  ...
  val STORE_1000 = TableStats(1002L, Map[String, ColumnStats](
    ...
    "s_rec_start_date" -> ColumnStats(4L, 9L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-03-12"),
      DateTimeTestUtil.UTCDate("1997-03-12")),
    "s_county" -> ColumnStats(28L, 0L, 14.09181636726547D, 22, "Ziebach County", ""),
    "s_division_id" -> ColumnStats(1L, 6L, 8.0D, 8, 1L, 1L),
    "s_rec_end_date" -> ColumnStats(3L, 501L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-03-11"),
      DateTimeTestUtil.UTCDate("1999-03-12")),
  ...
  val WEB_PAGE_1000 = TableStats(3000L, Map[String, ColumnStats](
    ...
    "wp_rec_start_date" -> ColumnStats(4L, 53L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-09-02"),
      DateTimeTestUtil.UTCDate("1997-09-02")),
    "wp_web_page_id" -> ColumnStats(1512L, 0L, 16.0D, 16, "AAAAAAAAPPKAAAAA", "AAAAAAAAAABAAAAA"),
    "wp_rec_end_date" -> ColumnStats(3L, 1500L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-09-01"),
      DateTimeTestUtil.UTCDate("1999-09-02")),
  ...
  val WEB_SITE_1000 = TableStats(54L, Map[String, ColumnStats](
    ...
    "web_rec_end_date" -> ColumnStats(3L, 27L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-08-14"),
      DateTimeTestUtil.UTCDate("1999-08-15")),
    ...
    "web_rec_start_date" -> ColumnStats(4L, 0L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-08-15"),
      DateTimeTestUtil.UTCDate("1997-08-15")),
  ...
  val ITEM_10000 = TableStats(402000L, Map[String, ColumnStats](
    ...
    "i_rec_start_date" -> ColumnStats(4L, 1030L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-10-26"),
      DateTimeTestUtil.UTCDate("1997-10-26")),
    "i_rec_end_date" -> ColumnStats(3L, 201000L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-10-25"),
      DateTimeTestUtil.UTCDate("1999-10-26")),
  ...
  val STORE_10000 = TableStats(1500L, Map[String, ColumnStats](
    ...
    "s_rec_start_date" -> ColumnStats(4L, 11L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-03-12"),
      DateTimeTestUtil.UTCDate("1997-03-12")),
    "s_county" -> ColumnStats(82L, 0L, 14.032D, 22, "Ziebach County", ""),
    "s_division_id" -> ColumnStats(1L, 7L, 8.0D, 8, 1L, 1L),
    "s_rec_end_date" -> ColumnStats(3L, 750L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-03-11"),
      DateTimeTestUtil.UTCDate("1999-03-12")),
    "s_market_id" -> ColumnStats(10L, 5L, 8.0D, 8, 10L, 1L)))
  ...
  val WEB_PAGE_10000 = TableStats(4002L, Map[String, ColumnStats](
    ...
    "wp_rec_start_date" -> ColumnStats(4L, 63L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-09-02"),
      DateTimeTestUtil.UTCDate("1997-09-02")),
    "wp_web_page_id" -> ColumnStats(2009L, 0L, 16.0D, 16, "AAAAAAAAPPNAAAAA", "AAAAAAAAAABAAAAA"),
    "wp_rec_end_date" -> ColumnStats(3L, 2001L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-09-01"),
      DateTimeTestUtil.UTCDate("1999-09-02")),
  ...
  val WEB_SITE_10000 = TableStats(78L, Map[String, ColumnStats](
    ...
    "web_rec_end_date" -> ColumnStats(3L, 39L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-08-14"),
      DateTimeTestUtil.UTCDate("1999-08-15")),
  ...
  val CALL_CENTER_10000 = TableStats(54L, Map[String, ColumnStats](
    ...
    "cc_rec_end_date" -> ColumnStats(3L, 27L, 12.0D, 12, DateTimeTestUtil.UTCDate("2001-12-30"),
      DateTimeTestUtil.UTCDate("1999-12-31")),
