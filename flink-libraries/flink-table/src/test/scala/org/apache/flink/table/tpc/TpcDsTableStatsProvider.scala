...
object TpcDsTableStatsProvider {
  ...
  val CALL_CENTER_1000 = TableStats(42L, Map[String, ColumnStats](
    ...
    "cc_rec_start_date" -> ColumnStats(4L, 1L, 4D, 4,
      Date.valueOf("2002-01-01"), Date.valueOf("1998-01-01")),
    "cc_rec_end_date" -> ColumnStats(3L, 21L, 4D, 4,
      Date.valueOf("2001-12-31"), Date.valueOf("2000-01-01")),
  ...
  val DATE_DIM_1000 = TableStats(73049L, Map[String, ColumnStats](
    ...
    "d_date" -> ColumnStats(66505L, 0L, 4D, 4,
      Date.valueOf("2100-01-01"), Date.valueOf("1900-01-02")),
  ...
  val ITEM_1000 = TableStats(300000L, Map[String, ColumnStats](
    ...
    "i_rec_start_date" -> ColumnStats(4L, 777L, 4D, 4,
      Date.valueOf("2001-10-27"), Date.valueOf("1997-10-27")),
    "i_rec_end_date" -> ColumnStats(3L, 150000L, 4D, 4,
      Date.valueOf("2001-10-26"), Date.valueOf("1999-10-27")),
  ...
  val STORE_1000 = TableStats(1002L, Map[String, ColumnStats](
    ...
    "s_rec_start_date" -> ColumnStats(4L, 9L, 4D, 4,
      Date.valueOf("2001-03-13"), Date.valueOf("1997-03-13")),
    "s_rec_end_date" -> ColumnStats(3L, 501L, 4D, 4,
      Date.valueOf("2001-03-12"), Date.valueOf("1999-03-13")),
  ...
  val WEB_PAGE_1000 = TableStats(3000L, Map[String, ColumnStats](
    ...
    "wp_rec_start_date" -> ColumnStats(4L, 53L, 4D, 4,
      Date.valueOf("2001-09-03"), Date.valueOf("1997-09-03")),
    "wp_rec_end_date" -> ColumnStats(3L, 1500L, 4D, 4,
      Date.valueOf("2001-09-02"), Date.valueOf("1999-09-03")),
  ...
  val WEB_SITE_1000 = TableStats(54L, Map[String, ColumnStats](
    ...
    "web_rec_start_date" -> ColumnStats(4L, 0L, 4D, 4,
      Date.valueOf("2001-08-16"), Date.valueOf("1997-08-16")),
    "web_rec_end_date" -> ColumnStats(3L, 27L, 4D, 4,
      Date.valueOf("2001-08-15"), Date.valueOf("1999-08-16")),
  ...
  val CALL_CENTER_10000 = TableStats(54L, Map[String, ColumnStats](
    ...
    "cc_rec_start_date" ->
        ColumnStats(4L, 1L, 4D, 4, Date.valueOf("2002-01-01"), Date.valueOf("1998-01-01")),
    "cc_rec_end_date" ->
        ColumnStats(3L, 27L, 4D, 4, Date.valueOf("2001-12-31"), Date.valueOf("2000-01-01")),
  ...
  val DATE_DIM_10000 = TableStats(73049L, Map[String, ColumnStats](
    ...
    "d_date_id" -> ColumnStats(73049L, 0L, 16D, 16, null, null),
    "d_date" ->
        ColumnStats(66505L, 0L, 4D, 4, Date.valueOf("2100-01-01"), Date.valueOf("1900-01-02")),
    "d_month_seq" -> ColumnStats(2262L, 0L, 8D, 8, 2400L, 0L),
    "d_week_seq" -> ColumnStats(9937L, 0L, 8D, 8, 10436L, 1L),
    "d_quarter_seq" -> ColumnStats(806L, 0L, 8D, 8, 801L, 1L),
    "d_year" -> ColumnStats(198L, 0L, 8D, 8, 2100L, 1900L),
  ...
  val ITEM_10000 = TableStats(402000L, Map[String, ColumnStats](
    ...
    "i_rec_start_date" ->
        ColumnStats(4L, 1030L, 4D, 4, Date.valueOf("2001-10-27"), Date.valueOf("1997-10-27")),
    "i_rec_end_date" ->
        ColumnStats(3L, 201000L, 4D, 4, Date.valueOf("2001-10-26"), Date.valueOf("1999-10-27")),
  ...
  val STORE_10000 = TableStats(1500L, Map[String, ColumnStats](
    ...
    "s_rec_start_date" ->
        ColumnStats(4L, 11L, 4D, 4, Date.valueOf("2001-03-13"), Date.valueOf("1997-03-13")),
    "s_rec_end_date" ->
        ColumnStats(3L, 750L, 4D, 4, Date.valueOf("2001-03-12"), Date.valueOf("1999-03-13")),
  ...
  val WEB_PAGE_10000 = TableStats(4002L, Map[String, ColumnStats](
    ...
    "wp_rec_start_date" ->
        ColumnStats(4L, 63L, 4D, 4, Date.valueOf("2001-09-03"), Date.valueOf("1997-09-03")),
    "wp_rec_end_date" ->
        ColumnStats(3L, 2001L, 4D, 4, Date.valueOf("2001-09-02"), Date.valueOf("1999-09-03")),
  ...
  val WEB_SITE_10000 = TableStats(78L, Map[String, ColumnStats](
    ...
    "web_rec_start_date" ->
        ColumnStats(4L, 0L, 4D, 4, Date.valueOf("2001-08-16"), Date.valueOf("1997-08-16")),
    "web_rec_end_date" ->
        ColumnStats(3L, 39L, 4D, 4, Date.valueOf("2001-08-15"), Date.valueOf("1999-08-16")),
