...
class TemporalTypesTest extends ExpressionTestBase {
  ...
  def testTimePointCasting(): Unit = {
    ...
    testTableApi(
      'f8.cast(DataTypes.TIMESTAMP).cast(DataTypes.LONG),
  ...
  def testTimeIntervalCasting(): Unit = {
    testTableApi(
      'f7.cast(DataTypes.INTERVAL_MONTHS),
      "f7.cast(INTERVAL_MONTHS)",
      "+1000-00")

    testTableApi(
      'f8.cast(DataTypes.INTERVAL_MILLIS),
  ...
  def testTimeIntervalArithmetic(): Unit = {
    ...
    testAllApis(
      -'f9.cast(DataTypes.INTERVAL_MONTHS),
      "-f9.cast(INTERVAL_MONTHS)",
      "-CAST(f9 AS INTERVAL YEAR)",
      "-2-00")

    testAllApis(
      -'f10.cast(DataTypes.INTERVAL_MILLIS),
