...
import org.apache.flink.table.api.scala.{Over, StreamTableEnvironment, proctime, _}
...
/**
  * set rewrite condition to a low value and check the correctness.
  */
class CodeGenerationRewriteTest {
  val env: StreamExecutionEnvironment = StreamExecutionEnvironment.getExecutionEnvironment
  val tableConfig = new TableConfig
  tableConfig.setCodegenRewriteEnabled(true)
  tableConfig.setCodegenRewriteMaxMethodLength(1L)
  tableConfig.setCodegenRewriteMaxMethodLengthAfterSplit(40)
  tableConfig.setCodegenRewriteMaxFieldCount(2)
