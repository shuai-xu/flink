...
/**
 * Test for DefaultParallelismCalculator.
 */
public class DefaultParallelismCalculatorTest {
	...
	public void setUp() {
		...
		tableConfig.getParameters().setString(TableConfig.SQL_EXEC_INFER_RESOURCE_MODE(), BatchExecResourceUtil.InferMode.ONLY_SOURCE.toString());
	...
	public void testOnlySource() {
		...
		new DefaultParallelismCalculator(mq, tableConfig).calculate(shuffleStage0);
