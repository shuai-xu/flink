...
public class ResettableExternalBufferTest {
	...
	public void before() {
		...
		this.serializer = new BinaryRowSerializer(Types.LONG);
		this.multiColumnFixedLengthSerializer = new BinaryRowSerializer(Types.BOOLEAN, Types.LONG, Types.INT);
		this.multiColumnVariableLengthSerializer = new BinaryRowSerializer(Types.BOOLEAN, Types.LONG, Types.STRING, Types.INT, Types.STRING);
	}
	...
	public void testMultiColumnFixedLengthRandomAccessLess() throws Exception {
		testMultiColumnRandomAccessLess(multiColumnFixedLengthSerializer, FixedLengthRowData.class);
	}

	@Test
	public void testMultiColumnFixedLengthRandomAccessSpill() throws Exception {
		testMultiColumnRandomAccessSpill(multiColumnFixedLengthSerializer, FixedLengthRowData.class);
	}

	@Test
	public void testBufferResetWithSpillAndMultiColumnFixedLengthRandomAccess() throws Exception {
		testBufferResetWithSpillAndMultiColumnRandomAccess(multiColumnFixedLengthSerializer, FixedLengthRowData.class);
	}

	@Test
	public void testMultiColumnVariableLengthRandomAccessLess() throws Exception {
		testMultiColumnRandomAccessLess(multiColumnVariableLengthSerializer, VariableLengthRowData.class);
	}

	@Test
	public void testMultiColumnVariableLengthRandomAccessSpill() throws Exception {
		testMultiColumnRandomAccessSpill(multiColumnVariableLengthSerializer, VariableLengthRowData.class);
	}

	@Test
	public void testBufferResetWithSpillAndMultiColumnVariableLengthRandomAccess() throws Exception {
		testBufferResetWithSpillAndMultiColumnRandomAccess(multiColumnVariableLengthSerializer, VariableLengthRowData.class);
	}
	...
	public void testFixedLengthRandomAccessOutOfRange() throws Exception {
		testRandomAccessOutOfRange(multiColumnFixedLengthSerializer, FixedLengthRowData.class);
	}
	...
	public void testVariableLengthRandomAccessOutOfRange() throws Exception {
		testRandomAccessOutOfRange(multiColumnVariableLengthSerializer, VariableLengthRowData.class);
	}
	...
	private void writeHuge(ResettableExternalBuffer buffer, int size) throws IOException {
		...
		writer.reset();
		writer.writeString(0, RandomStringUtils.random(size));
		writer.complete();
		buffer.add(row);
	}
	...
	private static class VariableLengthRowData implements RowData {
		...
		public VariableLengthRowData() {
			...
			col0 = random.nextBoolean();
			col1 = random.nextLong();
			col2 = RandomStringUtils.random(random.nextInt(50) + 1);
			col3 = random.nextInt();
			col4 = RandomStringUtils.random(random.nextInt(50) + 1);
		}
