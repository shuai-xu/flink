...
public class BytesHashMapTest {
	...
	public void testResetAndOutput() throws Exception {
		...
		final int preferMemSegments = 200;

		int minMemorySize = reservedMemSegments * PAGE_SIZE;
		int maxMemorySize = preferMemSegments * PAGE_SIZE;
		int perAllocatedMemorySize = 2 * PAGE_SIZE;

		MemoryManager memoryManager = new MemoryManager(
				minMemorySize, maxMemorySize, 32, MemoryManager.DEFAULT_PAGE_SIZE,
				MemoryType.HEAP, true);
		BytesHashMap table = new BytesHashMap(this, memoryManager,
				minMemorySize, maxMemorySize, perAllocatedMemorySize, keyTypes, valueTypes, true);
