...
public class SortMergeJoinIteratorTest {
	...
	private Tuple2<NormalizedKeyComputer, RecordComparator> sortBase =
			getIntSortBase(0, true, "SortMergeJoinIteratorTest");
	...
	public void before() throws MemoryAllocationException {
		...
		String tmpDir = EnvironmentInformation.getTemporaryFileDirectory();
		this.ioManager = new IOManagerAsync();
		this.serializer = new BinaryRowSerializer(Types.INT);
	}
