...
/**
 * A retract csv table factory.
 */
public class RetractCsvTableFactory implements StreamTableSinkFactory<Tuple2<Boolean, Row>> {
	@Override
	...
	public Map<String, String> requiredContext() {
		...
		context.put(CONNECTOR_TYPE, "RETRACTCSV");
