...
public abstract class Trigger<W extends Window> implements Serializable {
	...
	public interface TriggerContext {
		...
		/**
		 * Retrieves a sub-keyed {@link ValueState} object that can be used to interact with
	...
	public interface OnMergeContext extends TriggerContext {
		...
		/**
		 * Merges value states under the namespaces. Returns
		 * @return the merged result value, null if no merging happens.
		 */
		<T> T mergeValueState(ValueState<T> state, Merger<T> merger);
	}
}
