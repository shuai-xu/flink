...
/**
 * Base class for User-Defined table-valued Aggregates.
 *
 * <p>The behavior of an {@link TableValuedAggregateFunction} can be defined by implementing
 * a series of custom methods. An {@link TableValuedAggregateFunction} needs at least three methods:
 *  - createAccumulator,
 *  - accumulate, and
 *  - emitValue.
 *
 ...
 * {@link TableValuedAggregateFunction} functions, while other methods are explained below.
 *
 *
 * {@code
 ...
 */
public abstract class TableValuedAggregateFunction<T, ACC>
	 ...
	 *
	 * @param accumulator the accumulator which contains the current table-valued aggregated results
