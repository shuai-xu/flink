...
import org.apache.flink.table.examples.CsvSQLTableSink;
...
public class CsvTableFactory implements TableFactory {
	...
	public DimensionTableSource createDimensionTableSource(
		...
		CsvDimTable csvDimTable = new CsvDimTable(schema, properties, path, schema.getColumnNames(),
			schema.getColumnTypes(), emptyColumnAsNull);
