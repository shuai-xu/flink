...
/**
 * Left outer MiniBatch join operator.
 */
public class LeftOuterBatchJoinStreamOperator extends OuterBatchJoinStreamOperator {

	public LeftOuterBatchJoinStreamOperator(
			...
			JoinStateHandler.Type rightJoinTableType,
	...
	public void open() throws Exception {
		super.open();
		LOG.info("Init LeftOuterBatchJoinStreamOperator.");
	}
	...
	public void processBundles(
		...
		processSingleSideBundles(left, right, leftJoinStateType, rightJoinStateType, leftStateHandler,
				rightStateHandler, leftMatchStateHandler, rightMatchStateHandler, leftTimerState, true, true, false, out);
	}
