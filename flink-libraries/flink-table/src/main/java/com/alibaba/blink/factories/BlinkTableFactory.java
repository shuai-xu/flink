...
package com.alibaba.blink.factories;
 ...
 *
 */
public class BlinkTableFactory implements TableFactory {

	private ClassLoader classLoader;

	public static final BlinkTableFactory INSTANCE = new BlinkTableFactory();
	...
	static {
		DIRECTORY.put("CSV", "com.alibaba.blink.connectors.csv.CsvTableFactory");
		DIRECTORY.put("UPSERTCSV", "com.alibaba.blink.connectors.csv.UpsertCsvTableFactory");
		DIRECTORY.put("RETRACTCSV", "com.alibaba.blink.connectors.csv.RetractCsvTableFactory");
		DIRECTORY.put("PARQUET", "com.alibaba.blink.connectors.parquet.ParquetTableFactory");
		...
		DIRECTORY.put("ORC", "com.alibaba.blink.connectors.orc.OrcTableFactory");
		...
		// For IT tests
		DIRECTORY.put("TESTSOURCE", "com.alibaba.blink.launcher.autoconf.DummyTableFactory");
		DIRECTORY.put("TESTSINK", "com.alibaba.blink.launcher.autoconf.copy.PrintTableFactory");
	}
