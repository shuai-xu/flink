...
public class CacheConfig implements Serializable {
	...
	public CacheConfig(CacheStrategy cacheStrategy, List<Tuple2<Long, Long>> timeRangeBlacklist,
			int cacheScanLimit) {
	...
	public List<Tuple2<Long, Long>> getTimeRangeBlacklist() {
		return timeRangeBlacklist;
	}

	public int getCacheScanLimit() {
		return cacheScanLimit;
	}
}
