...
class FlinkRelMdFilteredColumnInterval private extends MetadataHandler[FilteredColumnInterval] {
  ...
  /**
    * Gets the column interval of the given column with filter argument in Project
  ...
  /**
    * Gets the column interval of the given column with filter argument in Filter
  ...
  /**
    * Gets the column interval of the given column with filter argument in Calc
  ...
  /**
    * Gets the column interval of the given column with filter argument in Exchange
  ...
  def getFilteredColumnInterval(
      ...
      filterArg: Int): ValueInterval = {
    val fmq = FlinkRelMetadataQuery.reuseOrCreate(mq)
    fmq.getFilteredColumnInterval(
      Util.first(subset.getBest, subset.getOriginal), columnIndex, filterArg)
  }
