...
/**
  * This rule is used to transpose FlinkLogicalLastRow to FlinkLogicalCalc to reduce state size.
  */
class LastRowCalcTransposeRule
  extends RelOptRule(
...
object LastRowCalcTransposeRule {
  val INSTANCE = new LastRowCalcTransposeRule
}
