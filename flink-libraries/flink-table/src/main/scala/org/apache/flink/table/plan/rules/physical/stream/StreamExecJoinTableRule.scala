...
class StreamExecJoinTableRule extends ConverterRule(
    classOf[FlinkLogicalJoinTable],
    FlinkConventions.LOGICAL,
    FlinkConventions.STREAMEXEC,
    "StreamExecJoinTableRule") {
...
object StreamExecJoinTableRule {
  val INSTANCE: RelOptRule = new StreamExecJoinTableRule()
