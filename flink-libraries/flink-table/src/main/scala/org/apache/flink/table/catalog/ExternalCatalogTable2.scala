...
class ExternalCatalogTableBuilder(private val connectorDescriptor: ConnectorDescriptor)
  ...
  /**
    ...
    */
  def asTableSource(): ExternalCatalogTable2 = {
    new ExternalCatalogTable2(
      isBatch,
      isStreaming,
      isSource = true,
      isSink = false,
  ...
  /**
    ...
    * @return External catalog table
    */
  def asTableSink(): ExternalCatalogTable2 = {
    new ExternalCatalogTable2(
      isBatch,
      isStreaming,
      isSource = false,
  ...
  /**
    ...
    * @return External catalog table
    */
  def asTableSourceAndSink(): ExternalCatalogTable2 = {
    new ExternalCatalogTable2(
      isBatch,
      isStreaming,
      isSource = true,
