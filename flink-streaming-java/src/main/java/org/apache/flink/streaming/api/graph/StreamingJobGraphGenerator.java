...
public class StreamingJobGraphGenerator {
	...
	private JobGraph createJobGraph(Configuration flinkConf) {
		...
		ClientUtils.addUserArtifactEntries(streamGraph.getCachedFiles(), jobGraph);
	...
	private JobVertex createJobVertex(
		...
		for (Integer nodeId : storager.chainedNodeIdsInOrder) {
			...
			final OperatorDescriptor operatorDescriptor = new OperatorDescriptor(node.getOperatorName(), operatorID, node.getId());
