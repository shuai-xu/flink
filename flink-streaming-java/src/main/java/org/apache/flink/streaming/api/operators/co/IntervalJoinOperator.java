...
public class IntervalJoinOperator<K, T1, T2, OUT>
	 ...
	 */
	@Override
	public TwoInputSelection processElement1(StreamRecord<T1> record) throws Exception {
	 ...
	 */
	@Override
	public TwoInputSelection processElement2(StreamRecord<T2> record) throws Exception {
