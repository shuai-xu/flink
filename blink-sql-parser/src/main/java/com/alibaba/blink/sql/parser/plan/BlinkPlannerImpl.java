...
package com.alibaba.blink.sql.parser.plan;

import com.alibaba.blink.sql.parser.ddl.SqlCreateFunction;
import com.alibaba.blink.sql.parser.ddl.SqlCreateTable;
import com.alibaba.blink.sql.parser.ddl.SqlCreateView;
import com.alibaba.blink.sql.parser.ddl.SqlNodeInfo;
import com.alibaba.blink.sql.parser.errorcode.ParserErrors;
import com.alibaba.blink.sql.parser.node.SqlToTreeConverter;
import com.alibaba.blink.sql.parser.plan.builder.BlinkRelBuilder;
import com.alibaba.blink.sql.parser.util.SqlInfo;
import com.alibaba.blink.sql.parser.util.SqlLists;
...
public class BlinkPlannerImpl {
	...
	private BlinkSqlValidator validator;
	private BlinkRelBuilder relBuilder;

	public BlinkPlannerImpl(FrameworkConfig frameworkConfig) {
		...
		this.validator = new BlinkSqlValidator(this.operatorTable, catalogReader, this.typeFactory);
...
//				return root;
	...
	private CalciteCatalogReader createCatalogReader() {
		SchemaPlus rootSchema = BlinkPlannerImpl.rootSchema(this.defaultSchema);
	...
	public BlinkSqlValidator getValidator() {
		return validator;
	}
}
