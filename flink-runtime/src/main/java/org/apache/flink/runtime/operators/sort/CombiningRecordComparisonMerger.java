...
public class CombiningRecordComparisonMerger<T> extends RecordComparisonMerger<T> {
	...
	public CombiningRecordComparisonMerger(GroupCombineFunction<T, T> combineStub, SortedDataFileFactory<T> sortedDataFileFactory,
										   IOManager ioManager,
										   TypeSerializer<T> typeSerializer, TypeComparator<T> typeComparator,
										   int maxFanIn, boolean enableObjectReuse) {
