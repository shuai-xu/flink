...
/**
 * Symptom indicating job vertices heap oom.
 */
public class JobVertexHeapOOM implements Symptom {

	private JobID jobID;
	private List<JobVertexID> jobVertexIDs;

	public JobVertexHeapOOM(JobID jobID, List<JobVertexID> jobVertexIDs) {
		this.jobID = jobID;
