...
/**
 * Symptom indicating job vertex failover.
 */
public class JobVertexFailover implements Symptom {

	private JobID jobID;
	private List<JobVertexID> jobVertexIDs;

	public JobVertexFailover(JobID jobID, List<JobVertexID> jobVertexIDs) {
		this.jobID = jobID;
