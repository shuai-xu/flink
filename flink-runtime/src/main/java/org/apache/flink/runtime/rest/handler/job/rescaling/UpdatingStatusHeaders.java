...
/**
 * Message headers for polling the status of an ongoing updating operation.
 */
public class UpdatingStatusHeaders extends
	AsynchronousOperationStatusMessageHeaders<AsynchronousOperationInfo, RescalingStatusMessageParameters> {

	private static final UpdatingStatusHeaders INSTANCE = new UpdatingStatusHeaders();
	...
	public static UpdatingStatusHeaders getInstance() {
		return INSTANCE;
	}

	@Override
	public String getDescription() {
		return "Returns the status of a updating operation.";
	}
}
