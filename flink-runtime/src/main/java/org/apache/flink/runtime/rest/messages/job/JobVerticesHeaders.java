...
/**
 * Message headers for the {@link JobVerticesInfoHandler}.
 */
public class JobVerticesHeaders implements MessageHeaders<EmptyRequestBody, JobVerticesInfo, JobMessageParameters> {
