...
public class UpdatingJobRequest implements RequestBody {
	...
	private final Map<JobVertexID, Tuple2<Integer, ResourceSpec>> vertexParallelismResource;

	@JsonCreator
	public UpdatingJobRequest(
		@JsonProperty(field_name_vertex_parallelism_resource)
		@Nonnull Map<JobVertexID, Tuple2<Integer, ResourceSpec>> vertexParallelismResource) {
		this.vertexParallelismResource = vertexParallelismResource;
	}

	@JsonIgnore
	public Map<JobVertexID, Tuple2<Integer, ResourceSpec>> getVertexParallelismResource() {
