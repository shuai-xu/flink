...
public class HeapInternalStateBackend extends AbstractInternalStateBackend {
	...
	public RunnableFuture<SnapshotResult<StatePartitionSnapshot>> snapshot(
		...
		final Map<String, StateTableSnapshot> keyedStateStableSnapshots = new HashMap<>(keyedStates.size());
		final Map<String, StateTableSnapshot> subKeyedStateStableSnapshots = new HashMap<>(subKeyedStates.size());
