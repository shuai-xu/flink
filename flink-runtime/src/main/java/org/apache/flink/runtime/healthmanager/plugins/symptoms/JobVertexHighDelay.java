...
/**
 * Symptom indicating job vertices high delay.
 */
public class JobVertexHighDelay implements Symptom {

	private JobID jobID;
	private List<JobVertexID> jobVertexIDs;

	public JobVertexHighDelay(JobID jobID, List<JobVertexID> jobVertexIDs) {
		this.jobID = jobID;
