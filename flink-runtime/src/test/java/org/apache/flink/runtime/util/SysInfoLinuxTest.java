 ...
 * Based on TestSysInfoLinux of YARN project.
 */
public class SysInfoLinuxTest extends TestLogger {
	@ClassRule
	...
	private FakeLinuxResourceCalculatorPlugin plugin;
	private String FAKE_MEMFILE;
	private String FAKE_CPUFILE;
	private String FAKE_STATFILE;
	private String FAKE_NETFILE;
	private String FAKE_DISKSFILE;
	private long FAKE_JIFFY_LENGTH = 10L;

	@Before
	public void setUp() throws Exception {
		final String TEST_ROOT_DIR = tempFolder.newFolder().getAbsolutePath();
