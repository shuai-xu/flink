...
/**
 * Tests for MaxTimelineAggregator.
 */
public class DeltaMaxTimelineAggregatorTest {

	@Test
	public void testAgg() {
		TimelineAggregator aggregator = TimelineAggregator.createTimelineAggregator(TimelineAggType.DELTA_MAX, 1000);
