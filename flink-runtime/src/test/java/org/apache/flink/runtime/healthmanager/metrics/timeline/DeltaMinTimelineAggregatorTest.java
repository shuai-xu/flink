...
/**
 * Tests for MinTimelineAggregator.
 */
public class DeltaMinTimelineAggregatorTest {

	@Test
	public void testAgg() {
		TimelineAggregator aggregator = TimelineAggregator.createTimelineAggregator(TimelineAggType.DELTA_MIN, 1000);
