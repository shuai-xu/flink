 ...
 * and value copy.
 */
public class GeminiFullHeapWithCopyCheckpointTest extends InternalStateCheckpointTestBase {
	...
	private Configuration getStateBackendConfiguration() {
		...
		configuration.setString(GeminiConfiguration.GEMINI_COPY_VALUE, "true");
