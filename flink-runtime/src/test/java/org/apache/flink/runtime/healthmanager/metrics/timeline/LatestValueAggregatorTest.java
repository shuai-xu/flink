...
/**
 * Tests for LastValueAggregator.
 */
public class LatestValueAggregatorTest {

	@Test
	public void testAgg() {
		LatestValueAggregator aggregator = new LatestValueAggregator(1);
		...
		assertEquals(aggregator.getValue(), Tuple2.of(2000L, 10.0));

	}

	@Test
	public void testNull() {
		LatestTimelineAggregator aggregator = new LatestTimelineAggregator(1);
