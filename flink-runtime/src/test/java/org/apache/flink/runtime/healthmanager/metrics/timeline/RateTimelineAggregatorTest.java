...
/**
 * Tests for RateTimelineAggregator.
 */
public class RateTimelineAggregatorTest {

	@Test
	public void testAgg() {
		RateTimelineAggregator aggregator = new RateTimelineAggregator(1000);
		aggregator.addValue(Tuple2.of(0L, 10.0));
		aggregator.addValue(Tuple2.of(999L, 20.0));
		aggregator.addValue(Tuple2.of(1000L, 30.0));
		assertEquals(aggregator.getValue(), Tuple2.of(0L, 10.0 * 1000 / 999));
