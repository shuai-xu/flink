 ...
 */
public class HBaseBytesSerializer {
	...
	public HBaseBytesSerializer(TypeInformation typeInfo, Charset charset) {
		this.typeIdx = HBaseTypeUtils.getTypeIndex(typeInfo);
		this.stringCharset = charset;
	}

	public byte[] toHBaseBytes(Object value) {
		return HBaseTypeUtils.serializeFromObject(value, typeIdx, stringCharset);
	}

	public Object fromHBaseBytes(byte[] value) {
