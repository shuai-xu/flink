...
/**
 * FlinkStandaloneHiveServerContext.
 */
public class FlinkStandaloneHiveServerContext implements HiveServerContext {
	...
	public FlinkStandaloneHiveServerContext(TemporaryFolder basedir, HiveRunnerConfig hiveRunnerConfig) {
	...
	protected void configureMetaStore(HiveConf conf) {
		...
		hiveConf.set("hive.metastore.uris", "thrift://localhost:20101");
	...
	protected final void createAndSetFolderProperty(
