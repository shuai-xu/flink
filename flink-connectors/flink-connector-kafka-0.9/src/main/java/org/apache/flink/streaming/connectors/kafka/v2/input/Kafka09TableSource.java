...
public class Kafka09TableSource extends KafkaBaseTableSource {
	...
	public FlinkKafkaConsumerBase createKafkaConsumer() {
		...
		if (!StringUtils.isNullOrWhitespaceOnly(topicPattern)) {
			...
			consumer = new FlinkKafkaConsumer09(pattern, kafkaMessageDeserialization, properties);
		} else {
			consumer = new FlinkKafkaConsumer09(topic, kafkaMessageDeserialization, properties);
		}
		return consumer;
	}
