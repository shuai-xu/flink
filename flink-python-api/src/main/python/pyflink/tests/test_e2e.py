...
def test_stream():
    ...
    # env_name = 'org.apache.flink.streaming.api.environment.LocalStreamEnvironment'
    # env_local_clz = TypesUtil.class_for_name(env_name)
    # j_env = env_local_clz()
    # env = LocalStreamEnvironment(j_env)
